...
| `toolCalls[]` (`name`, `argumentsHash`, `resultCount`) | Welke tool de orchestrator aanriep, met een hash van tekst/categorie/geo/topK en het aantal hits; bij een retry zonder categorie staan er twee | `AskOrchestrator` |
