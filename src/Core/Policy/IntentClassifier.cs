...
public sealed record Intent(
    [property: JsonPropertyName("domain")] string Domain,   // gezondheid|werk_inkomen|wonen|vervoer|welzijn|mantelzorg|out_of_scope
    [property: JsonPropertyName("intent")] string Kind,     // find_help|information|medical_advice|other
    [property: JsonPropertyName("corpus")] string Corpus)   // social-map
{
...
public sealed class OpenAiIntentClassifier(ChatClient chat) : IIntentClassifier
{
    public const string SystemPrompt =
        ...
        domain: gezondheid | werk_inkomen | wonen | vervoer | welzijn | mantelzorg | out_of_scope
        ...
        corpus: social-map voor sociale-kaart-domeinen
        """;

    public static readonly string SchemaJson = """
        { "type": "object", "additionalProperties": false,
          "properties": {
            "domain": { "type": "string", "enum": ["gezondheid","werk_inkomen","wonen","vervoer","welzijn","mantelzorg","out_of_scope"] },
            "intent": { "type": "string", "enum": ["find_help","information","medical_advice","other"] },
            "corpus": { "type": "string", "enum": ["social-map"] } },
